...
\begin{document}
    ...
    \begin{frame}{Who am I?}
        \begin{itemize}
            ...
            \item Started programming with Python in 2009
    ...
    \begin{frame}{Before I start}
        ...
        \end{block}
        \begin{block}{None of this will be assessed}<3->
            This talk is purely to introduce you to something different, that I think is important to know.
        \end{block}
        \begin{block}{Questions}<4->
    ...
    \begin{frame}{Example: Mars Pathfinder Rover (1997)}
        \begin{itemize}
            \item Imagine NASA’s Mars Pathfinder rover in 1997
            \item Inside its computer, everything is organised like a \textit{very busy kitchen}.
            \item The Mars Pathfinder rover kept rebooting because a low-priority logging task held a lock a high-priority system task needed, while medium-priority tasks kept interrupting.
        \end{itemize}

        \begin{minipage}{0.45\textwidth}
            \begin{figure}
                \includegraphics[width=\linewidth]{pathfinder}
            \end{figure}
        \end{minipage}
        \begin{minipage}{0.45\textwidth}
            \begin{figure}
                \includegraphics[width=\linewidth]{pathfinder2}
            \end{figure}
        \end{minipage}
    \end{frame}
    ...
    \begin{frame}{Example: Mars Pathfinder Rover (1997)}
        \begin{itemize}
            \item A low-priority chef in the kitchen grabbed the only mixing bowl
            \item \ldots while a high-priority chef urgently needs it.
            \item But before the low-priority chef can hand it over, another medium-priority chef keeps interrupting them.
            \item The head chef is stuck waiting
            \item and is unable to do their \textit{high priority} task
        \end{itemize}
    \end{frame}

    \begin{frame}{Example: Mars Pathfinder Rover (1997)}
        \begin{figure}
                \includegraphics[width=\linewidth]{priority_inversion}
            \end{figure}
    \end{frame}
